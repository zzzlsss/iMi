...
labels = hv.Labels(cat_ds, kdims=['x_pix', 'y_pix'],vdims=['ID']).opts(text_color='blue', text_font_size='11pt', yoffset=15,)

points = hv.Points(cat_ds, kdims=['x_pix', 'y_pix'],vdims=['ID','H2O_RA','H2O_Dec',
...
layout = (img * link_selections(points) * labels + link_selections(scatter))

if __name__ == "__main__":

    # Launch Panel app in browser
    pn.serve(layout, show=True, title="ice Mapping interface (iMi)")
